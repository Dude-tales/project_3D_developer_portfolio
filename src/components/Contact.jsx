    ...
    >
      ...
      >
        ...
        <div>
          ...
          <img src="src\assets\email.jpeg" height="100px" width="50px"></img><li>ahmedtahir2000@gmail.com</li>
          <ul className={styles.sectionSubText}>Phone:</ul>
          <li>+0092-321-25-75665</li>
         </table>
         <div className={styles.container}>
          <a href="https://github.com/ahmedtahirshekhani"><img src="src\assets\github.png" height="100px" width="50px"></img> </a>
          <a href="https://github.com/ahmedtahirshekhani"><img src="src\assets\stackoverflow.png" height="100px" width="50px"></img> </a>
         </div>
        </div>
      </motion.div>
